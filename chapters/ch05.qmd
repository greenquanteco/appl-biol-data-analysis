...
### Make arbitrary values with the c() function {#sec-manip-make-c}
...
### Generating sequences {#sec-manip-make-seq}

#### Consecutive values with the colon : operator {#sec-manip-make-seq-col}
...
#### Regular sequences with the seq() function {#sec-manip-make-seq-seq}
...
#### Repeated values with the rep() function {#sec-manip-make-seq-rep}
...
#### The recycling rule {#sec-manip-make-seq-rec}
...
### Random values {#sec-manip-make-rand}
...
#### The random number seed {#sec-manip-make-rand-seed}
...
#### Random values from a set with the sample() function {#sec-manip-make-rand-samp}
...
## Selecting data with square brackets {#sec-manip-select}
...
### Basics of brackets {#sec-manip-select-bas}
...
#### Selecting from a vector {#sec-manip-select-bas-vec}
...
#### Selecting from a matrix {#sec-manip-select-bas-mat}
...
#### Selecting from an array {#sec-manip-select-bas-arr}
...
#### Selecting from a data frame {#sec-manip-select-bas-df}
...
#### Selecting from lists {#sec-manip-select-bas-list}
...
## Dates and temporal data {#sec-manip-date}
...
### Dates without times {#sec-manip-date-date}
...
### Dates with times and time zones {#sec-manip-date-time}
...
### Working with dates and times {#sec-manip-date-work}
...
### Combining character strings {#sec-manip-char-comb}
...
### Printing character strings {#sec-manip-char-print}
...
The other printing function, `sink()`, is specifically for printing outputs into text files. Refer back to the @sec-ie-export-sink for an example.

### Matching character strings {#sec-manip-char-match}
...
Notice that this kind of matching is case-sensitive. If you need to match regardless of case, you can either force all of the comparands to be the same case, or use regular expressions (see @sec-manip-char-grep).
...
### Searching text with the grep() and grepl() functions {#sec-manip-char-grep}
...
### Replacing parts of character strings {#sec-manip-char-replace}
...
### Extracting from and splitting strings {#sec-manip-char-split}
...
### Matching text strings as indices {#sec-ie-char-inds}
...
The code below demonstrates how `match()` might be used in practice. This example uses `iris` and an imaginary second table. The commands use `match()` to assign a second variable, petal color, to iris using species as the key variable. We'll revisit this example dataset again in @sec-manip-df-oth-merg when we learn how to merge data frames.
...
### Standardizing numbers as text {#sec-manip-char-stan}
...
## Data frame management {#sec-manip-df}
...
### Data frame structure {#sec-manip-df-str}
...
When using [bracket notation](@sec-manip-select-bas), accessing parts of a data frame is the same as for a matrix. There are a couple of differences though:
...
### Common operations {#sec-manip-df-com}

#### Adding and deleting variables {#sec-manip-df-com-vars}
...
#### Modifying variables {#sec-manip-df-com-mod}
...
#### Changing values using a rule {#sec-manip-df-com-rule}
...
#### Renaming variables {#sec-manip-df-com-renam}
...
#### Rearranging columns {#sec-manip-df-com-rearr}
...
#### Sorting and ordering data {#sec-manip-df-com-sort}
...
#### Adding and removing rows {#sec-manip-df-com-add}
...
### Other operations {#sec-manip-df-oth}

#### Merging data frames {#sec-manip-df-oth-merg}
...
#### Reshaping data frames {#sec-manip-df-oth-shap}
