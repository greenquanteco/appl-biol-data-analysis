...
Selecting from an array is a lot like selecting from a matrix, only with one more dimension. Consider an array with 3 dimensions: rows, columns, and "layers"[^ch05-1].

[^ch05-1]: I don't know if there is an actual name for this, but I like to call them layers.
