...
Data frames can be combined by manually matching records between tables, using the function `match()`. The example below uses three interrelated tables from a stream dataset I work with. You need the datasets [neon_grids_2025-08-03.csv](https://greenquanteco.github.io/neon_grids_2025-08-03.csv) and [neon_measures_2025-08-03.csv](https://greenquanteco.github.io/neon_measures_2025-08-03.csv). Download them, put them in a folder, and make that folder your R working directory.
