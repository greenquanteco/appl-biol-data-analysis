...
![Illustration of a field experiment with 3 researcher-applied treatments, A, B, and C, arranged in blocks spread out over a landscape.](../images/review-blocking2.jpg){fig-alt="fig-alt="Schematic of a blocked experimental design with three treatments. Experimental units assigned to Treatment A, Treatment B, and Treatment C are represented by blue squares, orange triangles, and green circles, respectively. The units are arranged into nine blocks, shown as rectangles, with each block containing one unit from each treatment."}
...
The total variance is approximately $13.61+443.16+7.56=464.33$. Most of that variance ($100\left(443.16/464.33\right)\approx\text{95.4%}$) is attributed to differences between species. Only about 3% ($13.61/464.33$) is attributed to color. It's a small effect, but a significant one, and only detectable after accounting for species.
