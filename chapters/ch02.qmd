...
### Download and install R (and RStudio) {#sec-r-start-install}
...
## Commands, objects, and output {#sec-r-comm}
...
### R commands--basics {#sec-r-comm-basic}

In R, ***everything*** is an object. We will learn more about some of the most important R object types in the examples in @sec-object. Objects are created in R by many functions.
...
### Using R functions {#sec-r-comm-functions}
...
### The R workspace {#sec-r-comm-workspace}
...
### Object size and structure {#sec-r-syn-oss}
...
Assignment can also be used to **change or overwrite** parts of pre-existing objects. Usually this involves the bracket notation, which we will explore more in @sec-manip. In the example below, the third element of object `a`, `a[3]`, is replaced with the number 42.
...
### Installing R packages {#sec-r-pack-install}
...
### Working with packages in R {#sec-r-pack-work}
...
#### Package dependencies {#sec-r-pack-work-dep}
...
#### Citing packages {#sec-r-pack-work-cite}
...
## Frequently asked questions about R {#sec-r-faq}

### What is R {#sec-r-faq-what}
...
### Why do we have to write code? {#sec-r-faq-code}
...
### Advantages and disadvantages {#sec-r-faq-advdis}
...
-   R often requires more coding than SAS or other tools to get a similar amount of output or perform a similar amount of work. The `tidyverse` ecosystem of packages addresses some of these issues, but not without some costs (see #sec-r-faq-tidy).
...
### Base R vs. tidyverse {#sec-r-faq-tidy}
...
### Where can I get R help? {#sec-r-faq-help}
...
#### R documentation (help) files {#sec-r-faq-help-doc}
...
#### R vignettes {#sec-r-faq-help-vig}
...
#### Official resources {#sec-r-faq-help-off}
...
#### R mailing lists {#sec-r-faq-help-mail}
...
#### Unofficial online resources {#sec-r-faq-help-unoff}
...
#### Two reminders {#sec-r-faq-help-two}
