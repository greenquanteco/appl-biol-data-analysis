...
-   Tidyverse functions eschew use of the `$` operator, square brackets `[]`, and base R data structures in general[^ch02-2]. This means that people who learn only tidyverse are not equipped to take advantage of some of the most fundamental and powerful features of R--including many statistical functions!
...
[^ch02-2]: In my humble opinion, this aspect of tidyverse is just insane.
