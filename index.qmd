...
[Module 27](ch27.qmd#sec-27) introduces Bayesian inference using the program JAGS, another alternative to NHST.
...
Finally, [Appendix A](ch29.qmd#sec-29) describes the NEON dataset that I used to build most of this course, and the steps taken to process the raw data download to the files provided here.
