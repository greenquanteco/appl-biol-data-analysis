...
The Fall 2026 course syllabus can be [downloaded here](https://greenquanteco.github.io/files/biol-7410-syllabus-fall-2026.pdf).
...
1.  The famous `iris` dataset included with R. This will be used primarily in early modules covering data manipulation and data frame management, as well as the review of basic statistics in Modules 14 to 17.
2.  Datasets simulated *ad hoc* to demonstrate simple concepts with no underlying biological reality (e.g., numbers to demonstrate the properties of a probability distribution).
...
-   Access to a computer or laptop capable of running [R](https://cran.r-project.org/bin/windows/base/) version 4.0 or above. This site was rendered using R version 4.4.3 and the most recent version of any package mentioned (as of August 2026).
...
-   A separate program in which to write and edit code.
    ...
    -   My usual workflow includes two windows: the base R GUI, and [Notepad++](https://notepad-plus-plus.org/downloads/), although I've been using RStudio more and more because of the ease of integrating with Github.
...
This course has no required textbook. Or rather, this website is the textbook. If you want a textbook, then I recommend one of the following:
...
If you want a PDF version of this website, you can download it [here](Applied-Biological-Data-Analysis.pdf).
:::

::: {.content-visible when-format="pdf"}
An online version of this book is available at [https://greenquanteco.github.io/appl-biol-data-analysis/](https://greenquanteco.github.io/appl-biol-data-analysis/). The online version and the PDF hosted there are updated from time to time.
:::
...
[Module 32](chapters/ch32.qmd#sec-cart) introduces classification and regression trees (CART), a technique for flexibly capturing and modeling patterns in data without first deciding on a data model.
